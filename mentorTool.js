$(function() {
    ...
    function mentorBlock(mentor) {
       ...
       + mentor.directory + '">' + mentor.firstName + ' ' + mentor.lastName + '</a></strong><br />' 
    ...
    function selectItem(item) {
        ...
        if(mentorList.length === 0) {
                yourMentor.html("<h3>No Mentor Assigned!</h3><p>I'm sorry, there is currently no mentor assigned ot that department. Please contact <a href='mailto:gkaminsk@pcc.edu'>Greg Kaminkski</a> for more inform ation about the distance learning Faculty Mentor program at PCC.</p>");
    ...
    function fetchDepartments() {
        $.getJSON("http://localhost/mentors/departments.php", function(data) {
           departments = data;
    ...
    function fetchMentors() {
        $.getJSON("http://localhost/mentors/mentors.php", function(data) {
            mentors = data;
